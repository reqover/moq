...
export function RegisterRoutes(app: express.Router) {
    ...
    // ###########################################################################################################
        ...
        app.put('/moq/requests',
            ...
            function MockController_upadateMockRequestsApi(request: any, response: any, next: any) {
            const args = {
            ...
            try {
              ...
              const promise = controller.upadateMockRequestsApi.apply(controller, validatedArgs as any);
              promiseHandler(controller, promise, response, undefined, next);
            } catch (err) {
                return next(err);
            }
        ...
        app.get('/moq/scenarios/reset',
            ...
            function MockController_resetMockScenariosApi(request: any, response: any, next: any) {
            const args = {
            };
            ...
            try {
              ...
              const promise = controller.resetMockScenariosApi.apply(controller, validatedArgs as any);
              promiseHandler(controller, promise, response, undefined, next);
            } catch (err) {
                return next(err);
            }
        ...
        app.get('/moq/history',
            ...
            function MockController_getMockRequestsHistory(request: any, response: any, next: any) {
            const args = {
            };
            ...
            try {
              ...
              const promise = controller.getMockRequestsHistory.apply(controller, validatedArgs as any);
              promiseHandler(controller, promise, response, undefined, next);
            } catch (err) {
                return next(err);
            }
        ...
        app.delete('/moq/history',
            ...
            function MockController_deleteRequestsHistory(request: any, response: any, next: any) {
            const args = {
            };
            ...
            try {
              ...
              const promise = controller.deleteRequestsHistory.apply(controller, validatedArgs as any);
              promiseHandler(controller, promise, response, undefined, next);
            } catch (err) {
                return next(err);
            }
        ...
        app.post('/moq/proxy',
            ...
            function ProxyController_createProxyApi(request: any, response: any, next: any) {
            const args = {
                    body: {"in":"body","name":"body","required":true,"dataType":"nestedObjectLiteral","nestedProperties":{"url":{"dataType":"string","required":true},"name":{"dataType":"string","required":true}}},
            };
            ...
            try {
              ...
              const promise = controller.createProxyApi.apply(controller, validatedArgs as any);
              promiseHandler(controller, promise, response, undefined, next);
            } catch (err) {
                return next(err);
            }
        ...
        app.put('/moq/config',
            ...
            function ProxyController_recordingApi(request: any, response: any, next: any) {
            const args = {
                    serverName: {"default":"","in":"query","name":"serverName","dataType":"string"},
                    body: {"in":"body","name":"body","required":true,"dataType":"nestedObjectLiteral","nestedProperties":{"proxy":{"dataType":"nestedObjectLiteral","nestedProperties":{"omitHeaders":{"dataType":"array","array":{"dataType":"string"},"required":true},"enabled":{"dataType":"boolean","required":true}},"required":true},"serverUrl":{"dataType":"string","required":true}}},
            };
            ...
            try {
              ...
              const promise = controller.recordingApi.apply(controller, validatedArgs as any);
              promiseHandler(controller, promise, response, undefined, next);
            } catch (err) {
                return next(err);
            }
        ...
        app.get('/moq/config',
            ...
            function ProxyController_getConfigApi(request: any, response: any, next: any) {
            const args = {
                    serverName: {"default":"","in":"query","name":"serverName","dataType":"string"},
            };
            ...
            try {
              ...
              const promise = controller.getConfigApi.apply(controller, validatedArgs as any);
              promiseHandler(controller, promise, response, undefined, next);
            } catch (err) {
                return next(err);
            }
